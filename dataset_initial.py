...
def create_batches():
    ...
    with open("size_indices_new1.txt") as myfile: #select the first n_train examples as the training set, rest as validation set
    ...
    with open("training_indices_new2.txt") as myfile2: #select the first n_train examples as the training set, rest as validation set
